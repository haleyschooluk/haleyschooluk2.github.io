...
(function (BasketChamps) {
    var GameConstants = (function () {
        ...
        GameConstants.SPONSOR = GameConstants.GAMEDISTRIBUTION;
...
(function (BasketChamps) {
    ...
    (function (WhyCallAd) {
        ...
        WhyCallAd[WhyCallAd["onNextLevel"] = 3] = "onNextLevel";
    })(WhyCallAd = BasketChamps.WhyCallAd || (BasketChamps.WhyCallAd = {}));
    var SponsorManager = (function () {
        function SponsorManager() {
        }
        SponsorManager.adFilter = function (f, game, whyCallAd) {
            if (!BasketChamps.AdTimer.timeForAd()) {
                f();
                return;
            }
    ...
    BasketChamps.SponsorManager = SponsorManager;
})(BasketChamps || (BasketChamps = {}));
var BasketChamps;
(function (BasketChamps) {
...
(function (BasketChamps) {
    var Boot = (function (_super) {
        ...
        Boot.prototype.preload = function () {
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.MINIJUEGOS) {
                this.load.atlasJSONArray("texture_atlas_minijuegos", "/sponsors/texture_atlas_minijuegos.png", "/sponsors/texture_atlas_minijuegos.json");
            }
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.ADDICTING_GAMES) {
                this.load.audio("addicting_games_stinger", "/sponsors/sound.mp3", true);
                this.load.atlasXML("texture_atlas_addicting_games_stinger", "/sponsors/stinger_atlas.png", "/sponsors/stinger_atlas.xml");
            }
        };
        Boot.prototype.create = function () {
            ...
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.LAGGED) {
                ...
                if (top.location.href.indexOf("izzygames.com") || top.location.href.indexOf("spiele-umsonst.de") > -1 || top.location.href.indexOf("izzyjeux.fr") > -1 || top.location.href.indexOf("footchinko.com") > -1 || top.location.href.indexOf("localhost") > -1) {
                    this.game.state.start("PreLoader", true, false);
                }
            }
            else if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.FUNO) {
                if (top.location.href.indexOf("funo") > -1 || top.location.href.indexOf("yurk") > -1 || top.location.href.indexOf("friv") > -1 || top.location.href.indexOf("femo") > -1 || top.location.href.indexOf("fabo") > -1 || top.location.href.indexOf("localhost") > -1 || top.location.href.indexOf("127") > -1 || top.location.href.indexOf("192") > -1) {
                    this.game.state.start("PreLoader", true, false);
                }
            }
            else if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.YANDEX) {
                this.game.state.start("PreLoader", true, false);
            }
            else if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.NONE) {
                if (top.location.href.indexOf("footchinko.com") > -1 || top.location.href.indexOf("localhost") > -1) {
                    this.game.state.start("PreLoader", true, false);
                }
            }
            else if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.POKI) {
...
(function (BasketChamps) {
    var FinishMatch = (function (_super) {
        ...
        function FinishMatch(game) {
            ...
            _this.buttonNext = new Phaser.Button(_this.game, BasketChamps.GameConstants.GAME_WIDTH / 2 + 200, 320, "texture_atlas_1", function () {
                BasketChamps.SponsorManager.adFilter(function () {
                    _this.onNextClicked();
                }, _this.game, BasketChamps.WhyCallAd.onNextLevel);
            }, _this);
        ...
        FinishMatch.prototype.onNextClicked = function () {
            ...
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.POKI) {
                ...
                PokiSDK.commercialBreak()
                    .then(function () {
                    BasketChamps.Game.currentInstance.paused = false;
                    FinishMatch.currentInstance.pulseTween.stop();
                    FinishMatch.currentInstance.game.add.tween(FinishMatch.currentInstance.buttonNext.scale)
                        .to({ x: 0, y: 0 }, 650, Phaser.Easing.Elastic.In, true);
                    BasketChamps.StageContainer.currentInstance.efectsContainer.finishConfetti();
                    if (FinishMatch.currentInstance.win) {
                        FinishMatch.currentInstance.game.add.tween(FinishMatch.currentInstance.winnerImage)
                            .to({ x: -250 }, 500, Phaser.Easing.Back.In, true);
                        FinishMatch.currentInstance.game.add.tween(FinishMatch.currentInstance.winnerImage2)
                            .to({ x: 850 }, 500, Phaser.Easing.Back.In, true)
                            .onComplete.add(function () {
                            FinishMatch.currentInstance.game.time.events.add(500, function () {
                                FinishMatch.currentInstance.leavingScene = false;
                                FinishMatch.currentInstance.visible = false;
                                BasketChamps.TournamentManager.getInstance().nextMatch(FinishMatch.currentInstance.win);
                                BasketChamps.TournamentManager.getInstance().removeFlags();
                            }, FinishMatch.currentInstance);
                        }, FinishMatch.currentInstance);
                    }
                    else {
                        FinishMatch.currentInstance.game.add.tween(FinishMatch.currentInstance.loserImage)
                            .to({ x: -250 }, 500, Phaser.Easing.Back.In, true);
                        FinishMatch.currentInstance.game.add.tween(FinishMatch.currentInstance.loserImage2)
                            .to({ x: 850 }, 500, Phaser.Easing.Back.In, true)
                            .onComplete.add(function () {
                            FinishMatch.currentInstance.game.time.events.add(500, function () {
                                FinishMatch.currentInstance.leavingScene = false;
...
var BasketChamps;
(function (BasketChamps) {
    var AddictingGamesStinger = (function (_super) {
        __extends(AddictingGamesStinger, _super);
        function AddictingGamesStinger(game) {
            var _this = _super.call(this, game, null, "background-manager") || this;
            var background = _this.create(0, 0, _this.game.cache.getBitmapData("white_square"));
            background.scale.set(BasketChamps.GameConstants.GAME_WIDTH / 16, BasketChamps.GameConstants.GAME_HEIGHT / 16);
            var animatedLogo = _this.create(BasketChamps.GameConstants.GAME_WIDTH / 2, BasketChamps.GameConstants.GAME_HEIGHT / 2, "texture_atlas_addicting_games_stinger");
            animatedLogo.anchor.set(.5);
            animatedLogo.scale.set(.25);
            animatedLogo.animations.add("logo", Phaser.Animation.generateFrameNames("AddictingGamesStinger", 1, 132, "", 4));
            animatedLogo.animations.play("logo", 24, false)
                .onComplete.add(function () {
                this.game.add.tween(this)
                    .to({ alpha: 0 }, 350, Phaser.Easing.Quadratic.Out, true)
                    .onComplete.add(function () {
                    AddictingGamesStinger.animationFinished = true;
                    if (BasketChamps.PreLoader.currentInstance.assetsLoaded) {
                        BasketChamps.PreLoader.currentInstance.starGame();
                    }
                    this.destroy();
                }, this);
            }, _this);
            _this.game.sound.play("addicting_games_stinger");
            return _this;
        }
        AddictingGamesStinger.animationFinished = false;
        return AddictingGamesStinger;
    }(Phaser.Group));
    BasketChamps.AddictingGamesStinger = AddictingGamesStinger;
})(BasketChamps || (BasketChamps = {}));
var BasketChamps;
(function (BasketChamps) {
    var PreLoader = (function (_super) {
        ...
        PreLoader.prototype.init = function () {
            ...
            this.addictingGamesStinger = null;
        };
        PreLoader.prototype.preload = function () {
            ...
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.LAGGED) {
                this.load.image("logo-lagged", "/sponsors/lagged-3.png");
            }
        ...
        PreLoader.prototype.create = function () {
            ...
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.ADDICTING_GAMES) {
                if (BasketChamps.AddictingGamesStinger.animationFinished) {
                    this.starGame();
                }
            }
            else {
        ...
        PreLoader.prototype.initGameDistributionSDK = function () {
            window["GD_OPTIONS"] = {
                "gameId": "9346ec9f43664c4691fe55e8a5b2303b",
        ...
        PreLoader.prototype.starGame = function () {
            ...
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.GAMEPIX) {
                GamePix.game.gameLoaded(function () {
                    ...
                    BasketChamps.Game.currentInstance.state.start("SplashState", true, false);
                });
            }
            else {
                this.game.time.events.add(750, function () {
                    var _this = this;
                    BasketChamps.SponsorManager.adFilter(function () {
                        _this.game.state.start("SplashState", true, false);
                    }, this.game, BasketChamps.WhyCallAd.onGameStart);
                }, this);
            }
        };
        ...
        PreLoader.prototype.composeScene = function () {
            ...
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.MINIJUEGOS) {
                var moreGamesButtons = new BasketChamps.MinijuegosMoreGamesButton(this.game, BasketChamps.GameConstants.GAME_WIDTH / 2, 300);
                this.add.existing(moreGamesButtons);
            }
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.ADDICTING_GAMES) {
                this.addictingGamesStinger = new BasketChamps.AddictingGamesStinger(this.game);
                this.add.existing(this.addictingGamesStinger);
            }
        };
        return PreLoader;
    }(Phaser.State));
    ...
    var SplashState = (function (_super) {
        ...
        SplashState.prototype.create = function () {
            ...
            if (BasketChamps.GameVars.getInstance().myTeamID === 0) {
                ...
                this.moreGamesButton = this.add.button(-200, 300, "texture_atlas_1", this.onMoreGamesClicked, this);
                this.moreGamesButton.scale.set(.8);
                this.moreGamesButton.setFrames("boton_flappy_footchinko.png", "boton_flappy_footchinko.png", "boton_flappy_footchinko.png");
            }
            this.playButton.anchor.set(.5);
            this.playButton.scale.set(0);
            ...
            if (BasketChamps.GameConstants.SPONSOR !== BasketChamps.GameConstants.POKI && BasketChamps.GameConstants.SPONSOR !== BasketChamps.GameConstants.FUNO) {
                var copyRightLabel = this.add.text(18, BasketChamps.GameConstants.GAME_HEIGHT - 14, "made by RavalMatic, licensed to " + BasketChamps.GameConstants.SPONSOR, { font: "10px  Arial", fill: "#eeeeee" });
            ...
            else if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.ADDICTING_GAMES) {
                this.sponsorLogo = this.add.button(15, 280, "texture_atlas_1", this.onLogoClicked, this);
                this.sponsorLogo.setFrames("button_addictinggames_logo_on.png", "button_addictinggames_logo_off.png", "button_addictinggames_logo_on.png");
                this.sponsorLogo.visible = false;
            }
            else {
            ...
            this.game.camera.flash(0x000000, BasketChamps.GameConstants.TIME_FADE, false);
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.FUNO) {
                this.game.sound.mute = true;
        ...
        SplashState.prototype.showButtons = function () {
            if (BasketChamps.GameVars.getInstance().myTeamID === 0) {
                ...
                this.game.add.tween(this.moreGamesButton)
                    .to({ x: 20 }, 650, Phaser.Easing.Cubic.Out, true, 1000);
            }
        ...
        SplashState.prototype.onPlayClicked = function () {
            ...
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.POKI) {
                ...
                PokiSDK.commercialBreak()
                    ...
                    BasketChamps.Game.currentInstance.paused = false;
                    if (BasketChamps.GameVars.getInstance().myTeamID === 0) {
                        SplashState.currentInstance.newTournament();
                    }
                    else {
                        SplashState.currentInstance.playButton.visible = false;
                        SplashState.currentInstance.continueButton.visible = false;
                        SplashState.currentInstance.audioButton.visible = false;
                        SplashState.currentInstance.labelsContainer.visible = false;
                        SplashState.currentInstance.creditButton.visible = false;
                        SplashState.currentInstance.confirmationMenu = new BasketChamps.ConfirmationMenu(_this.game);
                        SplashState.currentInstance.add.existing(_this.confirmationMenu);
                    }
                    BasketChamps.AudioManager.getInstance().playSound("click");
        ...
        SplashState.prototype.onMoreGamesClicked = function () {
            if (this.leavingScene) {
                return;
            }
            window.open("https://footchinko.com/games/flappy-football/");
        };
        SplashState.prototype.onContinueClicked = function () {
            ...
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.POKI) {
                ...
                PokiSDK.commercialBreak()
                    .then(function () {
                    BasketChamps.Game.currentInstance.paused = false;
                    SplashState.currentInstance.continueButton.bringToTop();
                    SplashState.currentInstance.game.add.tween(SplashState.currentInstance.continueButton.scale)
                        .to({ y: 0 }, 500, Phaser.Easing.Cubic.Out, true, 100);
                    SplashState.currentInstance.game.add.tween(SplashState.currentInstance.continueButton.scale)
                        .to({ x: 0 }, 500, Phaser.Easing.Cubic.Out, true, 100);
                    SplashState.currentInstance.game.add.tween(SplashState.currentInstance.continueButton)
                        .to({ angle: 360 }, 500, Phaser.Easing.Cubic.Out, true, 100)
                        .onComplete.add(SplashState.currentInstance.goToBasketballCourt, SplashState.currentInstance);
                    BasketChamps.AudioManager.getInstance().playSound("click");
                });
            }
            else {
        ...
        SplashState.prototype.onLogoClicked = function () {
            var win;
            if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.MINIJUEGOS) {
                win = window.open(BasketChamps.GameConstants.LINK_MINIJUEGOS, "_blank");
                win.focus();
            }
            else if (BasketChamps.GameConstants.SPONSOR === BasketChamps.GameConstants.ADDICTING_GAMES) {
                win = window.open(BasketChamps.GameConstants.LINK_ADDICTINGGAMES, "_blank");
